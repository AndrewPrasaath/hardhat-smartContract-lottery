    ...
    : describe("Raffle", function () {
          ...
          describe("constructor", function () {
              it("Initializes the Raffle correctly", async function () {
                  ...
                  assert(interval.toString(), networkConfig[network.config.chainId]["interval"])
              })
          })

          describe("enterRaffle", function () {
              it("Reverts when you don't pay enough money", async function () {
          ...
          describe("performUpkeep", function () {
              ...
              it("updates raffle state, emits the event, and calls the vrf coordinator", async function () {
                  ...
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])
                  const txResponse = await raffle.performUpkeep("0x") //emits requetId
                  const txReceipt = await txResponse.wait(1) // waits 1 block
                  const requestId = txReceipt.events[1].args.requestId // updates state
                  const raffleState = await raffle.getRaffleState()
